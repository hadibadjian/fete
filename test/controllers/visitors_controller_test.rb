...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { company: @visitor.company, email: @visitor.email, first_name: @visitor.first_name, last_name: @visitor.last_name, phone: @visitor.phone }
    end
  ...
  test "should update visitor" do
    patch :update, id: @visitor, visitor: { company: @visitor.company, email: @visitor.email, first_name: @visitor.first_name, last_name: @visitor.last_name, phone: @visitor.phone }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
